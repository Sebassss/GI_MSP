...
(function( $ ){
    ...
    var methods = {
            ...
            $.fn.Grid = function(config) 
            {
            	...
            	loadCssFile("core/js/grid/Grid/inc/tableexport.css", "css") //dynamically load and add this .js file
				loadCssFile("core/js/grid/Grid/inc/Grid.css", "css") //dynamically load and add this .js file

				loadScript("core/js/grid/Grid/inc/velocity.min.js", function()
				{
				    loadScript("core/js/grid/Grid/inc/velocity.ui.min.js",function()
				    {
						loadScript("core/js/grid/Grid/inc/FileSaver.js",function()
						{
